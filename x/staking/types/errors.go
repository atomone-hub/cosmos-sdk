...
var (
	...
	ErrUnbondingNotFound               = errors.Register(ModuleName, 40, "unbonding operation not found")
	ErrUnbondingOnHoldRefCountNegative = errors.Register(ModuleName, 41, "cannot un-hold unbonding operation that is not on hold")
	ErrInvalidSigner                   = errors.Register(ModuleName, 42, "expected authority account as only signer for proposal message")
	...
	ErrCommissionOutOfBound            = errors.Register(ModuleName, 45, "commission rate is out of bounds")
)

...
//
//	mockgen -source=x/dynamicfee/post/expected_keepers.go -package post_test -destination x/dynamicfee/post/expected_keepers_mocks_test.go
//
...
import (
	...
	types "github.com/cosmos/cosmos-sdk/x/dynamicfee/types"
...
func (mr *MockDynamicfeeKeeperMockRecorder) GetEnabledHeight(ctx any) *gomock.Call {
...
func (mr *MockDynamicfeeKeeperMockRecorder) GetMaxBlockGas(ctx, params any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockDynamicfeeKeeperMockRecorder) GetParams(ctx any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockDynamicfeeKeeperMockRecorder) GetState(ctx any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockDynamicfeeKeeperMockRecorder) SetState(ctx, state any) *gomock.Call {
	mr.mock.ctrl.T.Helper()

...
func TestAnteHandle(t *testing.T) {
	...
	tests := []struct {
		...
		},
		{
			...
			expectedError: "unable to get min gas price for denom stake: OUPS",
		},
		{
			...
			expectedError: "error checking fee: got: 1stake required: 42stake, minGasPrice: 1.000000000000000000stake: insufficient fee",
		},
		{

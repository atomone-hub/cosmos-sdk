...
type Params struct {
	...
	// commission_auto_stake_epoch_identifier is the epoch identifier (e.g.
	// "week", "day") at which the bond denom portion of every bonded
	// validator's accumulated commission is automatically routed through
	// the staking Delegate path, compounding into the operator's
	// self-delegation. An empty string disables the epoch trigger;
	// operators can still trigger the same auto-stake by submitting
	// MsgWithdrawValidatorCommission.
	CommissionAutoStakeEpochIdentifier string `protobuf:"bytes,6,opt,name=commission_auto_stake_epoch_identifier,json=commissionAutoStakeEpochIdentifier,proto3" json:"commission_auto_stake_epoch_identifier,omitempty"`
}
...
func (m *Params) GetCommissionAutoStakeEpochIdentifier() string {
	if m != nil {
		return m.CommissionAutoStakeEpochIdentifier
	}
	return ""
}
...
var fileDescriptor_cd78a31ea281a992 = []byte{
	...
	,
}
...
func (this *Params) Equal(that interface{}) bool {
	...
	if this.CommissionAutoStakeEpochIdentifier != that1.CommissionAutoStakeEpochIdentifier {
		return false
	}
	return true
}
...
func (m *Params) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	var l int
	_ = l
	if len(m.CommissionAutoStakeEpochIdentifier) > 0 {
		i -= len(m.CommissionAutoStakeEpochIdentifier)
		copy(dAtA[i:], m.CommissionAutoStakeEpochIdentifier)
		i = encodeVarintDistribution(dAtA, i, uint64(len(m.CommissionAutoStakeEpochIdentifier)))
		i--
		dAtA[i] = 0x32
	}
	{
...
func (m *Params) Size() (n int) {
	...
	n += 1 + l + sovDistribution(uint64(l))
	l = len(m.CommissionAutoStakeEpochIdentifier)
	if l > 0 {
		n += 1 + l + sovDistribution(uint64(l))
	}
	return n
...
func (m *Params) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 6:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field CommissionAutoStakeEpochIdentifier", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.CommissionAutoStakeEpochIdentifier = string(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipDistribution(dAtA[iNdEx:])

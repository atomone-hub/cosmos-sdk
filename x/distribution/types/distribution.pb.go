...
type NakamotoBonus struct {
	...
	Minimum cosmossdk_io_math.LegacyDec `protobuf:"bytes,4,opt,name=minimum,proto3,customtype=cosmossdk.io/math.LegacyDec" json:"minimum"`
	Maximum cosmossdk_io_math.LegacyDec `protobuf:"bytes,5,opt,name=maximum,proto3,customtype=cosmossdk.io/math.LegacyDec" json:"maximum"`
}
...
var fileDescriptor_cd78a31ea281a992 = []byte{
	...
	,
}
...
func (m *NakamotoBonus) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	_ = l
	{
		size := m.Maximum.Size()
		i -= size
		if _, err := m.Maximum.MarshalTo(dAtA[i:]); err != nil {
			return 0, err
		}
	...
	dAtA[i] = 0x2a
	{
		size := m.Minimum.Size()
		i -= size
		if _, err := m.Minimum.MarshalTo(dAtA[i:]); err != nil {
			return 0, err
		}
		i = encodeVarintDistribution(dAtA, i, uint64(size))
	}

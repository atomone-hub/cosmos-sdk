...
type NakamotoBonus struct {
	// enabled indicates whether the Nakamoto Bonus feature is active
	Enabled bool `protobuf:"varint,1,opt,name=enabled,proto3" json:"enabled,omitempty"`
	// step defines the increment value applied to the bonus coefficient calculation
	Step cosmossdk_io_math.LegacyDec `protobuf:"bytes,2,opt,name=step,proto3,customtype=cosmossdk.io/math.LegacyDec" json:"step"`
	// period specifies the number of blocks over which the bonus coefficient is calculated
	Period uint64 `protobuf:"varint,3,opt,name=period,proto3" json:"period,omitempty"`
	// minimum_coefficient sets the lower bound for the bonus coefficient
	...
	// maximum_coefficient sets the upper bound for the bonus coefficient
	...
	// nakamoto_bonus_eligible_period is the duration validators must be active before becoming eligible for the Nakamoto
	// Bonus
	EligiblePeriod time.Duration `protobuf:"bytes,6,opt,name=eligible_period,json=eligiblePeriod,proto3,stdduration" json:"eligible_period"`
}
...
func (m *NakamotoBonus) GetEligiblePeriod() time.Duration {
	if m != nil {
		return m.EligiblePeriod
	}
	return 0
}
...
var fileDescriptor_cd78a31ea281a992 = []byte{
	...
	,
}
...
func (this *NakamotoBonus) Equal(that interface{}) bool {
	...
	if this.EligiblePeriod != that1.EligiblePeriod {
		return false
	}
	return true
}
...
func (m *NakamotoBonus) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	var l int
	_ = l
	n1, err1 := github_com_cosmos_gogoproto_types.StdDurationMarshalTo(m.EligiblePeriod, dAtA[i-github_com_cosmos_gogoproto_types.SizeOfStdDuration(m.EligiblePeriod):])
	if err1 != nil {
		return 0, err1
	}
	i -= n1
...
func (m *NakamotoBonus) Size() (n int) {
	...
	n += 1 + l + sovDistribution(uint64(l))
	l = github_com_cosmos_gogoproto_types.SizeOfStdDuration(m.EligiblePeriod)
	n += 1 + l + sovDistribution(uint64(l))
	return n
}
...
func (m *NakamotoBonus) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 6:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field EligiblePeriod", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if err := github_com_cosmos_gogoproto_types.StdDurationUnmarshal(&m.EligiblePeriod, dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:

...
const (
	...
	Query_MinDeposit_FullMethodName        = "/cosmos.gov.v1.Query/MinDeposit"
	Query_MinInitialDeposit_FullMethodName = "/cosmos.gov.v1.Query/MinInitialDeposit"
	Query_Quorums_FullMethodName           = "/cosmos.gov.v1.Query/Quorums"
	Query_ParticipationEMAs_FullMethodName = "/cosmos.gov.v1.Query/ParticipationEMAs"
)
